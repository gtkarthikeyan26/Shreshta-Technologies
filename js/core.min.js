...
! function(o) {
    ...
    o.fn.menumaker = function(t) {
        ...
        function p(t) {
            ...
            t.parents(".banner-headline").hasClass("type") ? ((e = t.parent(".banner-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function() {
                ...
                f(o, c)
            }, d)) : t.parents(".banner-headline").hasClass("letters") ? (i = t.children("i").length >= o.children("i").length, function t(e, i, o, s) {
                ...
                e.is(":last-child") ? o && setTimeout(function() {
                    ...
                    var n;
                    e.is(":last-child") && r("html").hasClass("no-csstransitions") && (n = m(i), y(i, n))
                }
            }(t.find("i").eq(0), t, i, s), g(o.find("i").eq(0), o, i, s)) : t.parents(".banner-headline").hasClass("clip") ? t.parents(".banner-words-wrapper").animate({
                width: "2px"
            }, u, function() {
                y(t, o), f(o)
            }) : t.parents(".banner-headline").hasClass("loading-bar") ? (t.parents(".banner-words-wrapper").removeClass("is-loading"), y(t, o), setTimeout(function() {
                p(o)
        ...
        function f(t, e) {
            t.parents(".banner-headline").hasClass("type") ? (g(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".banner-headline").hasClass("clip") && t.parents(".banner-words-wrapper").animate({
                width: t.width() + 10
            }, u, function() {
                setTimeout(function() {
                    p(t)
        ...
        r(".banner-headline.letters").find("b").each(function() {
            ...
            function(t) {
                ...
                t.each(function() {
                    var t, e, i, o = r(this);
                    o.hasClass("loading-bar") ? (s = n, setTimeout(function() {
                        o.find(".banner-words-wrapper").addClass("is-loading")
                    }, l)) : o.hasClass("clip") ? (e = (t = o.find(".banner-words-wrapper")).width() + 10, t.css("width", e)) : o.hasClass("type") || (e = o.find(".banner-words-wrapper b"), i = 0, e.each(function() {
                        var t = r(this).width();
                        i < t && (i = t)
                    }), o.find(".banner-words-wrapper").css("width", i)), setTimeout(function() {
        ...
        f.fn.extend({
            easyResponsiveTabs: function(l) {
                ...
                f(this).on("bind", "tabactivate", function(t, e) {
                    ...
                    var r, a = 0;
                    "" == u || null !== (r = u.match(new RegExp(s + "([0-9]+)"))) && 2 === r.length && (a = parseInt(r[1], 10) - 1, e < a && (a = 0)), f(o.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
        ...
        c.Defaults = {
            ...
            run: function(t) {
                ...
                for (t.items = {
                        merge: !1,
                        width: e
                    }; o--;) i = this._mergers[o], i = this.settings.mergeFit && Math.min(i, this.settings.items) || i, t.items.merge = 1 < i || t.items.merge, n[o] = s ? e * i : this._items[o].width();
                this._widths = n
            }
        }, {
            filter: ["items", "settings"],
            ...
            filter: ["width", "items", "settings"],
            run: function() {
                for (var t, e, i = this.settings.rtl ? 1 : -1, o = this._clones.length + this._items.length, s = -1, n = []; ++s < o;) t = n[s - 1] || 0, e = this._widths[this.relative(s)] + this.settings.margin, n.push(t + e * i);
                this._coordinates = n
            }
        }, {
            filter: ["width", "items", "settings"],
            ...
            run: function() {
                for (var t, e, i = this.settings.rtl ? 1 : -1, o = 2 * this.settings.stagePadding, s = this.coordinates(this.current()) + o, n = s + this.width() * i, r = [], a = 0, l = this._coordinates.length; a < l; a++) t = this._coordinates[a - 1] || 0, e = Math.abs(this._coordinates[a]) + o * i, (this.op(t, "<=", s) && this.op(t, ">", n) || this.op(e, "<", s) && this.op(e, ">", n)) && r.push(a);
            ...
            this.is("dragging") && (t.preventDefault(), this.settings.loop ? (i = this.coordinates(this.minimum()), o = this.coordinates(this.maximum() + 1) - i, n.x = ((n.x - i) % o + o) % o + i) : (i = this.settings.rtl ? this.coordinates(this.maximum()) : this.coordinates(this.minimum()), o = this.settings.rtl ? this.coordinates(this.minimum()) : this.coordinates(this.maximum()), e = this.settings.pullDrag ? -1 * s.x / 5 : 0, n.x = Math.max(Math.min(n.x, i + e), o + e)), this._drag.stage.current = n, this.animate(n.x))
            ...
            return this.settings.freeDrag || l.each(r, l.proxy(function(t, e) {
                return "left" === o && e - 30 < i && i < e + 30 ? s = t : "right" === o && e - n - 30 < i && i < e - n + 30 ? s = t + 1 : this.op(i, "<", e) && this.op(i, ">", r[t + 1] !== a ? r[t + 1] : e - n) && (s = "left" === o ? t + 1 : t), -1 === s
            ...
            var i, o = this.current(),
                ...
                a = this.minimum(),
                l = this.maximum();
            this.settings.loop ? (!this.settings.rewind && Math.abs(s) > r / 2 && (s += -1 * n * r), (i = (((t = o + s) - a) % r + r) % r + a) !== t && i - s <= l && 0 < i - s && (o = i - s, t = i, this.reset(o))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(a, Math.min(l, t)), this.speed(this.duration(o, t, e)), this.current(t), this.isVisible() && this.update()
            ...
            this._core = t, this._loaded = [], this._handlers = {
                "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(function(t) {
                    if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type)) {
                        ...
                        for (0 < e.lazyLoadEager && (i += e.lazyLoadEager, e.loop && (s -= e.lazyLoadEager, i++)); o++ < i;) this.load(n / 2 + this._core.relative(s)), n && a.each(this._core.clones(this._core.relative(s)), r), s++
                    }
                }, this)
    ...
    function(s, i) {
        var o = function(t) {
            ...
            }, this._core.options = s.extend({}, o.Defaults, this._core.options), this._core.$element.on(this._handlers), this._intervalId = null;
            var e = this;
    ...
    function(h, e) {
        ...
        i.Defaults = {
            ...
            var o, s, n = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "",
                r = e.find("img"),
                a = "src",
                l = "",
            ...
            this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), e = this._core.items(this._core.relative(e.index())), this._core.reset(e.index()), (t = h('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", s), t.attr("width", o), "youtube" === i.type ? t.attr("src", "//www.youtube.com/embed/" + i.id + "?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? t.attr("src", "//player.vimeo.com/video/" + i.id + "?autoplay=1") : "vzaar" === i.type && t.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"), h(t).wrap('<div class="owl-video-frame" />').insertAfter(e.find(".owl-video")), this._playing = e.addClass("owl-video-playing"))
    ...
    function(r) {
        ...
        e.Defaults = {
            ...
            var t, e, i, o, s, n;
            1 === this.core.settings.items && r.support.animation && r.support.transition && (this.core.speed(0), e = r.proxy(this.clear, this), i = this.core.$stage.children().eq(this.previous), o = this.core.$stage.children().eq(this.next), s = this.core.settings.animateIn, n = this.core.settings.animateOut, this.core.current() !== this.previous && (n && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(r.support.animation.end, e).css({
                left: t + "px"
    ...
    function(o, s, e) {
        ...
        i.Defaults = {
            ...
            this._call = s.setTimeout(o.proxy(this._next, this, t), this._timeout * (Math.round(this.read() / this._timeout) + 1) - this.read()), this._core.is("interacting") || e.hidden || this._core.next(t || this._core.settings.autoplaySpeed)
        }, i.prototype.read = function() {
            return (new Date).getTime() - this._time
        }, i.prototype.play = function(t, e) {
            var i;
            this._core.is("rotating") || this._core.enter("rotating"), t = t || this._core.settings.autoplayTimeout, i = Math.min(this._time % (this._timeout || t), t), this._paused ? (this._time = this.read(), this._paused = !1) : s.clearTimeout(this._call), this._time += this.read() % t - i, this._timeout = t, this._call = s.setTimeout(o.proxy(this._next, this, e), t - i)
        }, i.prototype.stop = function() {
    ...
    function(s) {
        ...
        e.Defaults = {
            ...
            var t, e, i, o, s = this._core.settings;
            ...
            var t = this._core.settings,
                ...
                o = t.loop || t.rewind;
            this._controls.$relative.toggleClass("disabled", !t.nav || e), t.nav && (this._controls.$previous.toggleClass("disabled", !o && i <= this._core.minimum(!0)), this._controls.$next.toggleClass("disabled", !o && i >= this._core.maximum(!0))), this._controls.$absolute.toggleClass("disabled", !t.dots || e), t.dots && (e = this._pages.length - this._controls.$absolute.children().length, t.dotsData && 0 != e ? this._controls.$absolute.html(this._templates.join("")) : 0 < e ? this._controls.$absolute.append(new Array(1 + e).join(this._templates[0])) : e < 0 && this._controls.$absolute.children().slice(e).remove(), this._controls.$absolute.find(".active").removeClass("active"), this._controls.$absolute.children().eq(s.inArray(this.current(), this._pages)).addClass("active"))
    ...
    function(o, s) {
        ...
        var e = function(t) {
            ...
            }, this._core.options = o.extend({}, e.Defaults, this._core.options), this.$element.on(this._handlers), o(s).on("hashchange.owl.navigation", o.proxy(function(t) {
    ...
    function(s, n) {
        ...
        function c(t) {
            ...
            return !!l("transition")
        }() || (s.support.transition = new String(c("transition")), s.support.transition.end = t.transition.end[s.support.transition]), o() && (s.support.animation = new String(c("animation")), s.support.animation.end = t.animation.end[s.support.animation]), e() && (s.support.transform = new String(c("transform")), s.support.transform3d = i())
        ...
        i.fn.counterUp = function(t) {
            ...
            return this.each(function() {
                var l = i(this),
                    c = e;
                l.waypoint(function() {
                    for (var t = [], e = c.time / c.delay, i = l.text(), o = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), s = (/^[0-9]+$/.test(i), /^[0-9]+\.[0-9]+$/.test(i)), n = s ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
    ...
    function(f, s, t, g) {
        var o = "stellar",
            ...
            l = {
                ...
                transform: {
                    setPosition: function(t, e, i, o, s) {
                        t[0].style[n] = "translate3d(" + (e - i) + "px, " + (o - s) + "px, 0)"
                    }
                }
            },
            n = function() {
            ...
            r = s.requestAnimationFrame || s.webkitRequestAnimationFrame || s.mozRequestAnimationFrame || s.oRequestAnimationFrame || s.msRequestAnimationFrame || function(t) {
                setTimeout(t, 1e3 / 60)
            };
        ...
        c.prototype = {
            ...
            _defineElements: function() {
                this.element === t.body && (this.element = s), this.$scrollElement = f(this.element), this.$element = this.element === s ? f("body") : this.$scrollElement, this.$viewportElement = this.options.viewportElement !== g ? f(this.options.viewportElement) : this.$scrollElement[0] === s || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
            },
            ...
            _defineSetters: function() {
                ...
                this._setScrollLeft = "function" == typeof e ? function(t) {
                    ...
                    i(n.$scrollElement, t)
                } : f.noop, this._setPosition = r.setPosition || function(t, e, i, o, s) {
            ...
            refresh: function(t) {
                var i = this,
                    e = i._getScrollLeft(),
                    o = i._getScrollTop();
                t && t.firstLoad || this._reset(), this._setScrollLeft(0), this._setScrollTop(0), this._setOffsets(), this._findParticles(), this._findBackgrounds(), t && t.firstLoad && /WebKit/.test(navigator.userAgent) && f(s).on("load", function() {
            ...
            _findParticles: function() {
                ...
                this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                    ...
                    p.options.showElement(l), l.data("stellar-startingLeft") ? (l.css("left", l.data("stellar-startingLeft")), l.css("top", l.data("stellar-startingTop"))) : (l.data("stellar-startingLeft", l.css("left")), l.data("stellar-startingTop", l.css("top"))), e = l.position().left, i = l.position().top, o = "auto" === l.css("margin-left") ? 0 : parseInt(l.css("margin-left"), 10), s = "auto" === l.css("margin-top") ? 0 : parseInt(l.css("margin-top"), 10), r = l.offset().left - o, a = l.offset().top - s, l.parents().each(function() {
                        var t = f(this);
                        if (!0 === t.data("stellar-offset-parent")) return c = d, h = u, n = t, !1;
                        d += t.position().left, u += t.position().top
                    }), o = l.data("stellar-horizontal-offset") !== g ? l.data("stellar-horizontal-offset") : n !== g && n.data("stellar-horizontal-offset") !== g ? n.data("stellar-horizontal-offset") : p.horizontalOffset, s = l.data("stellar-vertical-offset") !== g ? l.data("stellar-vertical-offset") : n !== g && n.data("stellar-vertical-offset") !== g ? n.data("stellar-vertical-offset") : p.verticalOffset, p.particles.push({
                        $element: l,
                        $offsetParent: n,
            ...
            _findBackgrounds: function() {
                ...
                this.backgrounds = [], this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)), t.each(function() {
                    ...
                    n.data("stellar-backgroundStartingLeft") ? m(n, n.data("stellar-backgroundStartingLeft"), n.data("stellar-backgroundStartingTop")) : (n.data("stellar-backgroundStartingLeft", r[0]), n.data("stellar-backgroundStartingTop", r[1])), t = "auto" === n.css("margin-left") ? 0 : parseInt(n.css("margin-left"), 10), e = "auto" === n.css("margin-top") ? 0 : parseInt(n.css("margin-top"), 10), i = n.offset().left - t - u, o = n.offset().top - e - p, n.parents().each(function() {
                        var t = f(this);
                        if (!0 === t.data("stellar-offset-parent")) return a = c, l = h, s = t, !1;
                        c += t.position().left, h += t.position().top
                    }), t = n.data("stellar-horizontal-offset") !== g ? n.data("stellar-horizontal-offset") : s !== g && s.data("stellar-horizontal-offset") !== g ? s.data("stellar-horizontal-offset") : d.horizontalOffset, e = n.data("stellar-vertical-offset") !== g ? n.data("stellar-vertical-offset") : s !== g && s.data("stellar-vertical-offset") !== g ? s.data("stellar-vertical-offset") : d.verticalOffset, d.backgrounds.push({
                        $element: n,
                        $offsetParent: s,
            ...
            _reset: function() {
                for (var t, e, i, o, s = this.particles.length - 1; 0 <= s; s--) e = (t = this.particles[s]).$element.data("stellar-startingLeft"), i = t.$element.data("stellar-startingTop"), this._setPosition(t.$element, e, e, i, i), this.options.showElement(t.$element), t.$element.data("stellar-startingLeft", null).data("stellar-elementIsActive", null).data("stellar-backgroundIsActive", null);
                for (s = this.backgrounds.length - 1; 0 <= s; s--)(o = this.backgrounds[s]).$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null), m(o.$element, o.startingValueLeft, o.startingValueTop)
            },
            destroy: function() {
            ...
            _repositionElements: function() {
                var t, e, i, o, s, n, r, a, l, c, h = this._getScrollLeft(),
        ...
        }, f[o].scrollProperty = a, f[o].positionProperty = l, s.Stellar = c
    ...
    function() {
        ...
        function i(t) {
            this.element = t, this.Adapter = p.Adapter, this.adapter = new this.Adapter(t), this.key = "waypoint-context-" + o, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
                ...
                vertical: {},
                horizontal: {}
            }, t.waypointContextKey = this.key, s[t.waypointContextKey] = this, o += 1, p.windowContext || (p.windowContext = !0, p.windowContext = new i(window)), this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
        }
        var o = 0,
            s = {},
            p = window.Waypoint,
        ...
        function t(o) {
            return function() {
                ...
                return o.isFunction(arguments[0]) && ((i = o.extend({}, arguments[1])).handler = arguments[0]), this.each(function() {
                    ...
                    "string" == typeof t.context && (t.context = o(this).closest(t.context)[0]), e.push(new s(t))
                }), e
            }
        }
    ...
    function(c) {
        ...
        c.fn.countdown = function(t, n) {
            ...
            function e() {
                ...
                i -= 60 * s * 60;
                e = Math.floor(i / 60);
                i -= 60 * e, 1 == o ? r.find(".timeRefDays").text("day") : r.find(".timeRefDays").text("days"), 1 == s ? r.find(".timeRefHours").text("hour") : r.find(".timeRefHours").text("hours"), 1 == e ? r.find(".timeRefMinutes").text("minute") : r.find(".timeRefMinutes").text("minutes"), 1 == i ? r.find(".timeRefSeconds").text("second") : r.find(".timeRefSeconds").text("seconds"), "on" == a.format && (o = 2 <= String(o).length ? o : "0" + o, s = 2 <= String(s).length ? s : "0" + s, e = 2 <= String(e).length ? e : "0" + e, i = 2 <= String(i).length ? i : "0" + i), isNaN(t) ? (alert("Invalid date. Here's an example: 12 Tuesday 2012 17:30:00"), clearInterval(l)) : (r.find(".days").text(o), r.find(".hours").text(s), r.find(".minutes").text(e), r.find(".seconds").text(i))
            }
            t && c.extend(a, t), e();
    ...
    function(t) {
        ...
        function d(t, e, i, o) {
            ...
            return s.className = "mfp-" + t, i && (s.innerHTML = i), o ? e && e.appendChild(s) : (s = c(s), e && s.appendTo(e)), s
        }
        ...
        t.prototype = {
            ...
            open: function(t) {
                ...
                if (!f.isOpen) {
                    ...
                    u("BeforeOpen"), f.st.showCloseBtn && (f.st.closeBtnInside ? (h(v, function(t, e, i, o) {
                    ...
                    }, 16), f.isOpen = !0, f.updateSize(r), u(b), t
                }
                f.updateItemHTML()
            },
            close: function() {
                f.isOpen && (u(y), f.isOpen = !1, f.st.removalDelay && !f.isLowIE && f.supportsTransition ? (f._addClassToMFP(i), setTimeout(function() {
                    f._close()
            ...
            updateSize: function(t) {
                var e;
                f.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, e = window.innerHeight * e, f.wrap.css("height", e), f.wH = e) : f.wH = t || x.height(), f.fixedContentPos || f.wrap.css("height", f.wH), u("Resize")
            },
            updateItemHTML: function() {
                var t = f.items[f.index];
                f.contentContainer.detach(), f.content && f.content.detach(), t.parsed || (t = f.parseEl(f.index));
                var e = t.type;
                u("BeforeChange", [f.currItem ? f.currItem.type : "", e]), f.currItem = t, f.currTemplate[e] || (i = !!f.st[e] && f.st[e].markup, u("FirstMarkupParse", i), f.currTemplate[e] = !i || c(i)), s && s !== t.type && f.container.removeClass("mfp-" + s + "-holder");
                var i = f["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, f.currTemplate[e]);
                f.appendContent(i, e), t.preloaded = !0, u("Change", t), s = t.type, f.container.prepend(f.contentContainer), u("AfterChange")
            },
            ...
            updateStatus: function(t, e) {
                var i;
                f.preloader && (o !== t && f.container.removeClass("mfp-s-" + o), e || "loading" !== t || (e = f.st.tLoading), u("UpdateStatus", i = {
                    status: t,
                    text: e
            ...
            _parseMarkup: function(s, t, e) {
                var n;
                e.data && (t = c.extend(e.data, t)), u(v, [s, t, e]), c.each(t, function(t, e) {
                    return void 0 === e || !1 === e || void(1 < (n = t.split("_")).length ? 0 < (i = s.find(w + "-" + n[0])).length && ("replaceWith" === (o = n[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === o ? i.is("img") ? i.attr("src", e) : i.replaceWith(c("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(n[1], e)) : s.find(w + "-" + t).html(e));
                    var i, o
                })
            },
            ...
            n();
            var e, i, o, s = c(this);
            return "string" == typeof t ? "open" === t ? (e = a ? s.data("magnificPopup") : s[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, o = e.items ? e.items[i] : (o = s, e.delegate && (o = o.find(e.delegate)), o.eq(i)), f._openClick({
                mfpEl: o
            }, s, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t), a ? s.data("magnificPopup", t) : s[0].magnificPopup = t, f.addGroup(s, t)), s
        };
            ...
            proto: {
                ...
                getInline: function(t, e) {
                    if (C(), t.src) {
                        var i, o = f.st.inline,
                            s = c(t.src);
                        return s.length ? ((i = s[0].parentNode) && i.tagName && (T || ($ = o.hiddenClass, T = d($), $ = "mfp-" + $), S = s.after(T).detach().removeClass($)), f.updateStatus("ready")) : (f.updateStatus("error", o.tNotFound), s = c("<div>")), t.inlineElement = s
                    }
                ...
                getAjax: function(o) {
                    ...
                    var t = c.extend({
                        ...
                        success: function(t, e, i) {
                            ...
                            u("ParseAjax", i), f.appendContent(c(i.data), O), o.finished = !0, k(), f._setFocus(), setTimeout(function() {
                                f.wrap.addClass(_)
        ...
        c.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function(t) {
                    t.img && (t.hasSize = !0, P && clearInterval(P), t.isCheckingImgSize = !1, u("ImageHasSize", t), t.imgHidden && (f.content && f.content.removeClass("mfp-loading"), t.imgHidden = !1))
                },
                    ...
                    var i = 0,
                        ...
                        s = function(t) {
                            P && clearInterval(P), P = setInterval(function() {
                                return 0 < o.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(P), void(3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)))
                            }, t)
                        };
                    s(1)
                },
                getImage: function(t, e) {
                    var i, o = 0,
                        s = function() {
                            t && (t.img[0].complete ? (t.img.off(".mfploader"), t === f.currItem && (f._onImageHasSize(t), f.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, u("ImageLoadComplete")) : ++o < 200 ? setTimeout(s, 100) : n())
                        },
                        n = function() {
        ...
        c.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function(t) {
                    ...
                    return void 0 === A && (A = void 0 !== document.createElement("p").style.MozTransform), A ? o["-moz-transform"] = o.transform = "translate(" + i.left + "px," + i.top + "px)" : (o.left = i.left, o.top = i.top), o
                }
            }
        });
        ...
        c.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                ...
                _preloadItem: function(t) {
                    var e;
                    t = M(t), f.items[t].preloaded || ((e = f.items[t]).parsed || (e = f.parseEl(t)), u("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
        ...
        ! function() {
            ...
            t.prototype.init = function() {
                ...
                if (i.core.$outer.find(".lg").append('<div class="lg-pager-outer"></div>'), i.core.s.dynamic)
                    for (var n = 0; n < i.core.s.dynamicEl.length; n++) s += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + i.core.s.dynamicEl[n].thumb + '" /></div></span>';
                else i.core.$items.each(function() {
                    i.core.s.exThumbImage ? s += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + r(this).attr(i.core.s.exThumbImage) + '" /></div></span>' : s += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + r(this).find("img").attr("src") + '" /></div></span>'
                });
            ...
            t.prototype.init = function() {
                ...
                if (i.find(".lg-object").hasClass("lg-has-poster") && i.find(".lg-object").is(":visible"))
                    if (i.hasClass("lg-has-video")) {
                        ...
                        o.core.s.dynamic ? s(o.core.s.dynamicEl[o.core.index].src, o.core.s.dynamicEl[o.core.index].html) : s(o.core.$items.eq(o.core.index).attr("href") || o.core.$items.eq(o.core.index).attr("data-src"), o.core.$items.eq(o.core.index).attr("data-html"));
                        s = i.find(".lg-object");
                        i.find(".lg-video").append(s), i.find(".lg-video-object").hasClass("lg-html5") || (i.removeClass("lg-complete"), i.find(".lg-video-object").on("load.lg error.lg", function() {
        ...
        ! function() {
            ...
            t.prototype.init = function() {
                ...
                n.core.s.actualSize && (t += '<button type="button" aria-label="Actual size" id="lg-actual-size" class="lg-icon"></button>'), n.core.s.useLeftForZoom ? n.core.$outer.addClass("lg-use-left-for-zoom") : n.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(t), n.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(t, e, i) {
                    ...
                    u("body").hasClass("lg-from-hash") && i ? o = 0 : u("body").removeClass("lg-from-hash"), n.zoomabletimeout = setTimeout(function() {
                ...
                function o(t, e, i, o) {
                    ...
                    n.core.$outer.hasClass("lg-zoomed") ? a = 1 : s < e && (a = e / s || 2), o ? (n.pageX = u(window).width() / 2, n.pageY = u(window).height() / 2 + u(window).scrollTop()) : (n.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX, n.pageY = t.pageY || t.originalEvent.targetTouches[0].pageY), r(), setTimeout(function() {
                ...
                if (!s) return 1;
                var n, i = 1;
                return "X" === e ? (n = Math.sign(parseFloat(s[0])), 0 === t || 180 === t ? i = 1 : 90 === t && (i = -90 === o && 1 === n || 90 === o && -1 === n ? -1 : 1), i *= n) : (n = Math.sign(parseFloat(s[3])), 0 === t || 180 === t ? i = 1 : 90 === t && (t = parseFloat(s[1]), s = parseFloat(s[2]), i = Math.sign(t * s * o * n)), i *= n), i
                ...
                s.core.$slide.on("mousedown.lg.zoom", function(t) {
                    o = s.core.$slide.eq(s.core.index).find(".lg-img-rotate")[0], d = s.getCurrentRotation(o);
                    var e = s.core.$slide.eq(s.core.index).find(".lg-object"),
                        e = s.getDragAllowedAxises(e, Math.abs(d));
                    h = e.allowY, c = e.allowX, s.core.$outer.hasClass("lg-zoomed") && u(t.target).hasClass("lg-object") && (c || h) && (t.preventDefault(), n = s.getDragCords(t, Math.abs(d)), a = !0, s.core.$outer.scrollLeft += 1, --s.core.$outer.scrollLeft, s.core.$outer.removeClass("lg-grab").addClass("lg-grabbing"))
                }), u(window).on("mousemove.lg.zoom", function(t) {
                    var e, i;
                    a && (e = s.core.$slide.eq(s.core.index).find(".lg-img-wrap"), l = !0, r = s.getDragCords(t, Math.abs(d)), s.core.$outer.addClass("lg-zoom-dragging"), i = h ? -Math.abs(e.attr("data-y")) + (r.y - n.y) * s.getModifier(d, "Y", o) : -Math.abs(e.attr("data-y")), t = c ? -Math.abs(e.attr("data-x")) + (r.x - n.x) * s.getModifier(d, "X", o) : -Math.abs(e.attr("data-x")), s.core.s.useLeftForZoom ? e.css({
                        left: t + "px",
                        top: i + "px"
                    }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)"))
                }), u(window).on("mouseup.lg.zoom", function(t) {
                    a && (a = !1, s.core.$outer.removeClass("lg-zoom-dragging"), !l || n.x === r.x && n.y === r.y || (r = s.getDragCords(t, Math.abs(d)), s.touchendZoom(n, r, c, h, d)), l = !1), s.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")
                })
    ...
    function(t) {
        ...
        function e(t) {
            ...
            if ((t = h.event.fix(i)).type = "mousewheel", "detail" in i && (r = -1 * i.detail), "wheelDelta" in i && (r = i.wheelDelta), "wheelDeltaY" in i && (r = i.wheelDeltaY), "wheelDeltaX" in i && (n = -1 * i.wheelDeltaX), "axis" in i && i.axis === i.HORIZONTAL_AXIS && (n = -1 * r, r = 0), s = 0 === r ? n : r, "deltaY" in i && (s = r = -1 * i.deltaY), "deltaX" in i && (n = i.deltaX, 0 === r && (s = -1 * n)), 0 !== r || 0 !== n) {
                ...
                return f && !(a < f) || u(i, f = a) && (f /= 40), u(i, a) && (s /= 40, n /= 40, r /= 40), s = Math[1 <= s ? "floor" : "ceil"](s / f), n = Math[1 <= n ? "floor" : "ceil"](n / f), r = Math[1 <= r ? "floor" : "ceil"](r / f), m.settings.normalizeOffset && this.getBoundingClientRect && (a = this.getBoundingClientRect(), l = t.clientX - a.left, c = t.clientY - a.top), t.deltaX = n, t.deltaY = r, t.deltaFactor = f, t.offsetX = l, t.offsetY = c, t.deltaMode = 0, o.unshift(t, s, n, r), p && clearTimeout(p), p = setTimeout(d, 200), (h.event.dispatch || h.event.handle).apply(this, o)
            }
        }
    ...
    function(e, i) {
        ...
        function i(l, c, h) {
            (h = h || e || t.jQuery) && (c.prototype.option || (c.prototype.option = function(t) {
                ...
                var o, s, n, r, a, e = d.call(arguments, 1);
                return s = e, r = "$()." + l + '("' + (o = t) + '")', (t = this).each(function(t, e) {
                    var i = h.data(e, l);
                    i ? (e = i[o]) && "_" != o.charAt(0) ? (i = e.apply(i, s), n = void 0 === n ? i : n) : u(r + " is not a valid method") : u(l + " not initialized. Cannot call methods, i.e. " + r)
                }), void 0 !== n ? n : t
            }, o(h))
        }
    ...
    function(t, e) {
        ...
        function g(t) {
            if (b || (b = !0, (u = document.createElement("div")).style.width = "200px", u.style.padding = "1px 2px 3px 4px", u.style.borderStyle = "solid", u.style.borderWidth = "1px 2px 3px 4px", u.style.boxSizing = "border-box", (d = document.body || document.documentElement).appendChild(u), h = f(u), g.isBoxSizeOuter = m = 200 == p(h.width), d.removeChild(u)), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                var e = f(t);
                ...
                o = p(e.height);
                return !1 !== o && (i.height = o + (t ? 0 : l + u)), i.innerWidth = i.width - (a + d), i.innerHeight = i.height - (l + u), i.outerWidth = i.width + c, i.outerHeight = i.height + h, i
            }
            var u, d, h
        }
    ...
    function(t, e) {
        ...
        t.constructor = i, t._create = function() {
            ...
            s = o ? "paddingTop" : "paddingBottom", i = o ? "top" : "bottom", o = o ? "bottom" : "top", s = this.position.y + t[s];
            e[i] = this.getYValue(s), e[o] = "", this.css(e), this.emitEvent("layout", [this])
    ...
    function(s, n) {
        ...
        function r(t, e) {
            ...
            i ? (this.element = i, c && (this.$element = c(this.element)), this.options = o.extend({}, this.constructor.defaults), this.option(e), e = ++h, this.element.outlayerGUID = e, (d[e] = this)._create(), this._getOption("initLayout") && this.layout()) : l && l.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
        }
    ...
    function(r, a) {
        ...
        s._create = function() {
            ...
            for (var e = (e = this.options.filter) || "*", i = [], o = [], s = [], n = this._getFilterTest(e), r = 0; r < t.length; r++) {
                var a, l = t[r];
            ...
            E = {
                ...
                util: {
                    ...
                    clone: function i(t, o) {
                        var s, e, n = E.util.type(t);
                        switch (o = o || {}, n) {
                            case "Object":
                                if (e = E.util.objId(t), o[e]) return o[e];
                                for (var r in s = {}, o[e] = s, t) t.hasOwnProperty(r) && (s[r] = i(t[r], o));
                                return s;
                            case "Array":
                                return e = E.util.objId(t), o[e] || (s = [], o[e] = s, t.forEach(function(t, e) {
                                    s[e] = i(t, o)
                                }), s);
                            default:
                                return t
                ...
                languages: {
                    ...
                    DFS: function t(e, i, o, s) {
                        ...
                        for (n in e) e.hasOwnProperty(n) && (i.call(e, n, e[n], o || n), r = e[n], "Object" !== (a = E.util.type(r)) || s[l(r)] ? "Array" !== a || s[l(r)] || (s[l(r)] = !0, t(r, i, n, s)) : (s[l(r)] = !0, t(r, i, null, s)))
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function(t, e, i) {
                    ...
                    for (var s, n = o.elements || t.querySelectorAll(o.selector), r = 0; s = n[r++];) E.highlightElement(s, !0 === e, o.callback)
                },
                highlightElement: function(t, e, i) {
                    for (var o, s = "none", n = t; n && !c.test(n.className);) n = n.parentNode;
                    n && (s = (n.className.match(c) || [, "none"])[1].toLowerCase(), o = E.languages[s]), t.className = t.className.replace(c, "").replace(/\s+/g, " ") + " language-" + s, t.parentNode && (n = t.parentNode, /pre/i.test(n.nodeName) && (n.className = n.className.replace(c, "").replace(/\s+/g, " ") + " language-" + s));
                        ...
                        if (i.hasOwnProperty(a) && i[a]) {
                            ...
                            for (var l = i[a], l = "Array" === E.util.type(l) ? l : [l], c = 0; c < l.length; ++c) {
                                var h, d = l[c],
                                    ...
                                    g = 0,
                                    m = d.alias;
                                f && !d.pattern.global && (h = d.pattern.toString().match(/[imuy]*$/)[0], d.pattern = RegExp(d.pattern.source, h + "g")), d = d.pattern || d;
                                for (var y = o, v = s; y < e.length; v += e[y].length, ++y) {
                                    ...
                                    if (!(b instanceof I)) {
                                        ...
                                        if (T) {
                                            ...
                                            if (b.push(z), k && b.push(k), Array.prototype.splice.apply(e, b), 1 != S && E.matchGrammar(t, e, i, y, v, !0, a), n) break
                                        } else if (n) break
                                    }
                                }
                            }
