...
! function(s) {
    ...
    function o() {
        var e, o;
        e = s(".full-screen"), o = i.height(), e.css("min-height", o), e = s("header").height(), o = s(".screen-height"), e = i.height() - e, o.css("height", e)
    }
    s("#preloader").fadeOut("normall", function() {
        ...
        e <= 50 ? (s("header").removeClass("scrollHeader").addClass("fixedHeader"), o.attr("src", "img/logos/logo-inner.png")) : (s("header").removeClass("fixedHeader").addClass("scrollHeader"), o.attr("src", "img/logos/logo.png")), t.attr("src", "img/logos/logo.png"), a.attr("src", "img/logos/logo.png")
    }), i.on("scroll", function() {
    ...
    })), o(), s(".current-year").text((new Date).getFullYear()), s(document).ready(function() {
        s(".vision-changebg").owlCarousel({
            ...
            e = e.item.index - 2;
            s("h3").removeClass("animated fadeInDown"), s("h1").removeClass("animated fadeInLeft"), s("p").removeClass("animated fadeInLeft"), s(".butn").removeClass("animated fadeInUp"), s(".video_btn").removeClass("animated fadeInUp"), s(".video-text").removeClass("animated fadeInUp"), s(".owl-item").not(".cloned").eq(e).find("h3").addClass("animated fadeInDown"), s(".owl-item").not(".cloned").eq(e).find("h1").addClass("animated fadeInLeft"), s(".owl-item").not(".cloned").eq(e).find("p").addClass("animated fadeInLeft"), s(".owl-item").not(".cloned").eq(e).find(".butn").addClass("animated fadeInUp"), s(".owl-item").not(".cloned").eq(e).find(".video_btn").addClass("animated fadeInUp"), s(".owl-item").not(".cloned").eq(e).find(".video-text").addClass("animated fadeInUp")
        }), 0 !== s(".horizontaltab").length && s(".horizontaltab").easyResponsiveTabs({
            type: "default",
            width: "auto",
            fit: !0,
            tabidentify: "hor_1",
        ...
        }), 0 !== s(".verticaltab").length && s(".verticaltab").easyResponsiveTabs({
            type: "vertical",
            width: "auto",
            fit: !0,
            closed: "accordion",
        ...
        }), s(".portfolio-gallery,.portfolio-gallery-isotope").lightGallery(), s(".portfolio-link").on("click", e => {
            e.stopPropagation()
        }), i.stellar()
    })
}(jQuery);